...
"[project]/Documents/WS/widelystudioswebsite/node_modules/prismjs/plugins/diff-highlight/prism-diff-highlight.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(function() {
    ...
    Prism.hooks.add('wrap', function(env) {
        ...
        if (PREFIXES && env.type in PREFIXES) {
            /** @type {string} */ var content = env.content.replace(HTML_TAG, ''); // remove all HTML tags
            /** @type {string} */ var decoded = content.replace(/&lt;/g, '<').replace(/&amp;/g, '&');
...
//# sourceMappingURL=15a63_prismjs_plugins_diff-highlight_prism-diff-highlight_a79f3909.js.map