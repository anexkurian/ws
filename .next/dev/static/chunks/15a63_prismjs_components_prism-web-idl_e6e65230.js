...
"[project]/Documents/WS/widelystudioswebsite/node_modules/prismjs/components/prism-web-idl.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(function(Prism1) {
    ...
    for(var key in Prism1.languages['web-idl']){
        if (key !== 'class-name') {
            typeInside[key] = Prism1.languages['web-idl'][key];
        }
    }
    Prism1.languages['webidl'] = Prism1.languages['web-idl'];
})(Prism);
}),
]);

//# sourceMappingURL=15a63_prismjs_components_prism-web-idl_e6e65230.js.map