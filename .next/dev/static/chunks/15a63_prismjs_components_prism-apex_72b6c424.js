...
"[project]/Documents/WS/widelystudioswebsite/node_modules/prismjs/components/prism-apex.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(function(Prism1) {
    ...
    Prism1.languages.apex = {
        'comment': Prism1.languages.clike.comment,
        'string': Prism1.languages.clike.string,
        'sql': {
            pattern: /((?:[=,({:]|\breturn)\s*)\[[^\[\]]*\]/i,
            lookbehind: true,
            greedy: true,
            alias: 'language-sql',
            inside: Prism1.languages.sql
        },
        'annotation': {
            pattern: /@\w+\b/,
            alias: 'punctuation'
...
//# sourceMappingURL=15a63_prismjs_components_prism-apex_72b6c424.js.map